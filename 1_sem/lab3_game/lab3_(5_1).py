...
pygame.draw.rect(screen, hight_color, (0, 0.25 * height, length, 0.26 * height))
pygame.draw.polygon(screen, back_mountains_color, [(0, 0.5 * height),
                                       ...
                                       (length, 0.2 * height),
                                       (length, 0.4 * height)])
pygame.draw.circle(screen, sun_color, (int(0.5 * length), int(0.25 * height)), 80)

pygame.draw.rect(screen, back_color, (0, 0.5 * height, length, 0.25 * height))
pygame.draw.ellipse(screen, front_mountains_color, (0.04 * length, 0.45 * height, 200, 400))
pygame.draw.ellipse(screen, front_mountains_color, (0.62 * length, 0.55 * height, 140, 380))
